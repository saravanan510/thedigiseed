...
const Button = ({ children, type }) => {
  if (type == "contained") {
    return (
      <div className="bg-linear-to-t from-[#242424] to-[#000] text-white tracking-wide flex gap-3 max-w-fit rounded-[80px] p-1.5 pl-5 text-base cursor-pointer shadow-lg ">
